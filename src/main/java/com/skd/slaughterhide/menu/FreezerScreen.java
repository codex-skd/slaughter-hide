...
public class FreezerScreen extends AbstractContainerScreen<FreezerMenu> {
    private static final Identifier BACKGROUND = Identifier.parse("slaughter_hide:textures/gui/container/freezer.png");

    public FreezerScreen(FreezerMenu menu, Inventory playerInv, Component title) {
